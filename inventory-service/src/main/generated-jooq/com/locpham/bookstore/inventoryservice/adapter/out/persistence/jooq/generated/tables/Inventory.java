...
public class Inventory extends TableImpl<InventoryRecord> {
    ...
    /**
     * The column <code>public.inventory.isbn</code>.
     */
    public final TableField<InventoryRecord, String> ISBN = createField(DSL.name("isbn"), SQLDataType.VARCHAR(255).nullable(false), this, "");

    /**
     * The column <code>public.inventory.available_quantity</code>.
     */
    public final TableField<InventoryRecord, Integer> AVAILABLE_QUANTITY = createField(DSL.name("available_quantity"), SQLDataType.INTEGER.nullable(false).defaultValue(DSL.field(DSL.raw("0"), SQLDataType.INTEGER)), this, "");

    /**
     * The column <code>public.inventory.reserved_quantity</code>.
     */
    public final TableField<InventoryRecord, Integer> RESERVED_QUANTITY = createField(DSL.name("reserved_quantity"), SQLDataType.INTEGER.nullable(false).defaultValue(DSL.field(DSL.raw("0"), SQLDataType.INTEGER)), this, "");

    /**
     * The column <code>public.inventory.version</code>.
     */
    public final TableField<InventoryRecord, Long> VERSION = createField(DSL.name("version"), SQLDataType.BIGINT.nullable(false).defaultValue(DSL.field(DSL.raw("0"), SQLDataType.BIGINT)), this, "");
    ...
    public List<UniqueKey<InventoryRecord>> getUniqueKeys() {
        return Arrays.asList(Keys.INVENTORY_ISBN_KEY);
    }
